...
class AboutVariableScope < Neo::Koan
  ...
  # class variable belong to the class and there's only one copy of that variable that is shared with all instances of that class.
  #  Instance variable belong to the instance of a class, thus an object And every instance of that class (object) has it's own copy of that variable.
