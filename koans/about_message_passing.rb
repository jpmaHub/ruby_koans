...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # send() is a method in root class Object.
    # send can be used if the name send doesn't clashes with an existing method in obj. Also, the name send is readable and clearer
    # __send__ exists so it can't be over-written by accident because some classes define their own send method which has nothing to do with Object#send.
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    #
    # It wouldn't cause the NoMethodError, and the call would
    # conform to the redefined behavior.
    #
    # NOTE:
    #
