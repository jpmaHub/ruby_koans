...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # It works like accumulator like sum in loop. It is adding the numbers up in iteration
    # Parameter can take numbers to add in the array
  end
  ...
  # The first method iterates through the file one line at a time and store array of strings before the block.
  # The second method opens the contents of the entire file.
  #
  # When you get to the "AboutSandwichCode" koan, recheck your answer.
  # It make sure the file will close automatically for us when the block ends.
