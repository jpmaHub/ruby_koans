...
class AboutClassMethods < Neo::Koan
  ...
  # I prefer the first way because it is clearer and defines the class and instance methods separate
  #
  # Are there times you might prefer one over the other?
  # I might use other way when I want my method to be private or protected and also keeping all of my class methods in the same block.
