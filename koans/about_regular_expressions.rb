...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why?
  # The default is greedy for repetition which keeps searching until the condition is not satisfied.
  # However, Lazy stop searching once condition is satisfied and it takes minimal steps.
  # Adding a ? to a quantifier to make it ungreedy i.e lazy.
  ...
  # Character classes ([...]) are optimized for matching one of the included characters and it is more readable,
  # and alternatives (|) allow for more general choices of varying lengths.
